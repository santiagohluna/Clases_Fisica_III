...
\begin{questions}
    ...
    \begin{parts}
        \part La cantidad mínima de masa $\Delta m$ que se debe agregar al balde viene dada por: $$ \Delta m = \frac{\mu_\text{e} \, k \left(L_1 - L_2\right)}{g} - m_0, $$ donde $\mu_\text{e}$ es el coeficiente estático de rozamiento entre el volante y el freno.
