...
\begin{frame}{Descripción matemática de las ondas}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[scale=1]
            ...
            \draw[blue,very thick,samples=100,smooth,variable=\x,domain=0:4.5] plot(\x,{exp(-(\x-2)^2/0.5)});
        \end{tikzpicture}
    \end{figure}

    En este caso, la perturbación se describe como la distancia (hacia arriba o hacia abajo) en la que la cuerda se aparta de la línea horizontal que caracteriza su estado de equilibrio.
