...
\begin{frame}{Reflexión y transmisión de ondas en discontinuidades}
    ...
    Analicemos ahora las condiciones que se deben cumplir en la unión de las dos cuerdas. Si consideramos los extremos de las cuerdas que se unen en $x=0$, vemos que $\vec{F}_1$ es la fuerza con que la cuerda 1 tira de la cuerda 2, mientras que $\vec{F}_2$ es la fuerza con la que la cuerda 2 tira de la cuerda 1. En virtud de la tercera ley de Newton tenemos que: $ \vec{F}_1 + \vec{F}_2 = \vec{0}$.
...
\begin{frame}{Reflexión y transmisión de ondas en discontinuidades}
    ...
    \begin{align*}
        F_{1,y} &= F_{1,x} \tan \beta_1 = F_{1,x} \pdiff{y_1}{x} \\
        F_{2,y} &= F_{2,x} \tan \beta_2 = F_{2,x} \pdiff{y_2}{x}.
    \end{align*} Por lo que: 
    \begin{align*}
        \vec{F}_1 &= - \, F_{1,x} \, \ver{e}_x - F_{1,x} \pdiff{y_1}{x} \, \ver{e}_y \\
        \vec{F}_1 &= F_{2,x} \, \ver{e}_x + F_{2,x} \pdiff{y_2}{x} \, \ver{e}_y.
    \end{align*} Luego: $$ \left(F_{2,x} - \, F_{1,x} \right) \ver{e}_x + \left(- F_{1,x} \pdiff{y_1}{x} + F_{2,x} \pdiff{y_2}{x} \right) \ver{e}_y = \vec{0}. $$
...
\begin{frame}{Reflexión y transmisión de ondas en discontinuidades}
    ...
    \begin{align*}
        F_{2,x} - \, F_{1,x} &= 0 \\
        - F_{1,x} \pdiff{y_1}{x} + F_{2,x} \pdiff{y_2}{x} = 0,
    \end{align*} de donde se obtiene que $$ F_{2,x} = F_{1,x} = F_x \qquad \text{ y } \qquad F_x \, \pdiff{y_2}{x} = F_x \pdiff{y_1}{x} $$ O, simplemente: $$ F_x \, \pdiff{y_2}{x} = F_x \pdiff{y_1}{x}. $$
