        ...
        \begin{column}{0.45\textwidth}
            \begin{figure}
                ...
                \begin{tikzpicture}
                    ...
                    \draw[thick,-latex,blue] (P1) -- node[left=4pt,pos=0.7]{$\diff \vec{r}$} (Q1);
                    \draw[thick,-latex,blue] (P2) -- node[right=4pt,pos=0.3]{$\diff \vec{r}^{\, \prime}$} (Q2);
                    
                    %% Desplazamientos

                    \draw[thick,-latex,red] (P1) -- node[above right]{$\vec{u}$} (P2);
                    \draw[thick,-latex,red] (Q1) -- node[above right]{$\vec{u}^{\, \prime}$} (Q2);
                    
                    \draw[thick,-latex] (O) -- node[pos=0.6,left]{$\vec{r}_P$} (P1) node[left]{$P$};
                    \draw[thick,-latex] (O) -- node[right,pos=0.7]{$\vec{r}_Q$} (Q1) node[above]{$Q$};
                    \draw[thick,-latex] (O) -- node[below,near end]{$\vec{r}_{P'}$} (P2) node[below right=-3pt]{$P'$};
                    \draw[thick,-latex] (O) -- node[above,pos=0.4]{$\vec{r}_{Q'}$} (Q2) node[right]{$Q'$};
...
\begin{frame}{Tensor de deformación}
    ...
    Como consecuencia de la deformación, el punto $P$ se traslada al punto $P'$ y el punto $Q$ se traslada al punto $Q'$. Sean $\vec{u}$ y $\vec{u}^{\, \prime}$ los respectivos desplazamientos de estos puntos.
        ...
        \begin{column}{0.45\textwidth}
            \begin{figure}
                ...
                \begin{tikzpicture}
                    ...
                    \draw[thick,-latex] (O) -- node[right,pos=0.7]{$\vec{r}_P(t)$} (P1) node[above]{$P$};
                    \draw[thick,-latex] (O) -- node[right=10pt,pos=0.4]{$\vec{r}_{P'} (t+\diff t)$} (P2) node[right]{$P'$};
